...
class UnitTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unit_type" do
    assert_difference('UnitType.count') do
      post unit_types_url, params: { unit_type: { amount_off: @unit_type.amount_off, bedroom: @unit_type.bedroom, name: @unit_type.name, percentage_off: @unit_type.percentage_off, type: @unit_type.type } }
    end
  ...
  test "should update unit_type" do
    patch unit_type_url(@unit_type), params: { unit_type: { amount_off: @unit_type.amount_off, bedroom: @unit_type.bedroom, name: @unit_type.name, percentage_off: @unit_type.percentage_off, type: @unit_type.type } }
